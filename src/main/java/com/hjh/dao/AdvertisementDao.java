...
public interface AdvertisementDao extends BaseMapper<Advertisement> {
    ...
    List<Map<String ,Object>> selectMyAd(Page<MyAd> var1, @Param("userId") String userId, @Param("adType") Integer adType, @Param("adSpec") Integer adSpec, @Param("adStatus") Integer adStatus, @Param("isOnlyMy")String isOnlyMy);
